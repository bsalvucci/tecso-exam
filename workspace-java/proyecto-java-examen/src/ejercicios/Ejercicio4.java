...
public class Ejercicio4 {
	...
	public static void main(String[] args) {
		...
		/*
		  Cuenta la cantidad de numeros pares que tiene lista1 y los imprime en consola.
		  Agrega los numeros impares a un nuevo array e imprime esa lista en consola.
		  Calcula la cantidad de elementos de lista 1 (10) y lo divide por 2 (5). Luego
		  busca la posicion del numero 5 en el array. La posicion es 2. Muestra la posicion en 
		  consola.
		  Luego, cuenta los numeros elementos de lista1 que sean mayores que "numero". En 
		  cualquier caso imprime "...".	  
		*/
